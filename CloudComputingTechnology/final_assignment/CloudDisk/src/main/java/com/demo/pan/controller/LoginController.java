...
import static com.demo.pan.util.FileUtil.deleteDir;

import com.demo.pan.dao.model.User;
import com.demo.pan.model.ResponseMsg;
import com.demo.pan.service.IUserService;
import com.demo.pan.service.IVerifyCodeService;
import com.demo.pan.util.FileUtil;
import com.demo.pan.util.Md5SaltTool;
import com.demo.pan.util.SystemUtil;
import com.demo.pan.util.WebUtil;

import com.demo.pan.service.impl.FileServiceImpl;
...
public class LoginController {
    ...
    public String loginOut(HttpServletRequest request) {
        if (!SystemUtil.isWindows()) {
            // 非windows环境下要删除用户文件
            FileUtil.deleteDir(FileServiceImpl.fileRootPath + WebUtil.getUserNameByRequest(request));
        }
