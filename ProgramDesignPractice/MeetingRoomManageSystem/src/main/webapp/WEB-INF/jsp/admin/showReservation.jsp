			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">Reservation Review</h1>
				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${reservationList}" var="item">
								<tr>
									...
									<td>${item.mark}</td>
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='${pageContext.request.contextPath}/admin/reviewReservation?id=${item.id}'">Approve</button>
									</td>
								</tr>
							</c:forEach>
					        </tbody>
				    ...
				    <div class="panel-footer">
						<c:if test="${pagingVO != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath}/admin/showReservation?page=${pagingVO.upPageNo}">&laquo;Last Page</a></li>
									...
									<li><a href="${pageContext.request.contextPath}/admin/showReservation?page=${pagingVO.totalCount}">Final Page&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
