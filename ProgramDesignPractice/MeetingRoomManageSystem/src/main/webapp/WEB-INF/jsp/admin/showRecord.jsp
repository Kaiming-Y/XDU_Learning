				    ...
				    <div class="panel-footer">
						<c:if test="${pagingVo != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath}/admin/showRecord?page=${pagingVo.upPageNo}">&laquo;Last Page</a></li>
									...
									<li><a href="${pageContext.request.contextPath}/admin/showRecord?page=${pagingVo.totalCount}">Final Page&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
