...
<html>
<head>
	<title>Meeting Room Information query</title>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
					    	<h1 class="col-md-5">Meeting Room Information query</h1>
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="${pageContext.request.contextPath}/ordinary/queryRoom" id="form1" method="post">
								<div class="input-group">
									<input type="text" class="form-control" placeholder="Please enter meeting room name" name="findByName">
				    ...
				    <div class="panel-footer">
						<c:if test="${pagingVO != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath}/ordinary/showRoom?page=${pagingVO.upPageNo}">&laquo;Last page</a></li>
									...
									<li><a href="${pageContext.request.contextPath}/ordinary/showRoom?page=${pagingVO.totalCount}">Final page&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
        ...
        function removeRoom(id) {
			if(confirm('Are you sure you want to delete this customer?')) {
				$.post("${pageContext.request.contextPath}/ordinary/removeRoom",{"id":id},function(data){
					alert("The customer deleted the update successfully!");
